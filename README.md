...
The following word cloud shows the different cuisines in our data set (the size reflects the number of recipes): 
![image](figs/Rplot.png)

The following word cloud shows the assortment of ingredients that were in the data set: 
![image](figs/ingredients.png)
