...
def feature_selection(file, variance_explained = 0.99):
...
train_data, test_data = train_test_split(features_data, test_size = 0.25, stratify = features_data.cuisine)

train_data.to_csv('../output/train_data.csv', header=False, index=False)
test_data.to_csv('../output/test_data.csv', header=False, index=False)